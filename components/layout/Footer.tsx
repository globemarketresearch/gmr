  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative bg-[#1c2333] text-white">
        ...
        <div className="relative container mx-auto px-6 pt-14 pb-14 lg:px-10">
          <div
            className="rounded-xl px-6 py-7 sm:px-8"
            style={{
      ...
      <div className="bg-[#fdfdfd] text-slate-800 border-t border-slate-200">
            ...
            <div className="flex flex-col items-center text-center">
              <Link href="/" className="inline-block mb-2 group">
                <Image
                  ...
                  height={88}
                  sizes="320px"
                  className="h-40 w-auto rounded-lg opacity-90 group-hover:opacity-100 transition-opacity duration-200"
                />
              </Link>
              ...
              <div className="flex gap-2 justify-center">
                {socials.map(({ href, Icon, label }) => (
                  <Link
                    ...
                    className="w-8 h-8 rounded-full border border-slate-300 flex items-center justify-center text-slate-400 hover:text-sky-600 hover:border-sky-400 hover:bg-sky-50 transition-all duration-200"
                    aria-label={label}
                  >
              ...
              <ul className="space-y-3 text-sm">
                {quickLinks.map(({ href, label }) => (
                  <li key={label}>
                    <Link
                      href={href}
                      className="text-slate-500 hover:text-sky-600 transition-colors duration-150"
                    >
                      {label}
                    </Link>
                  </li>
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <div className="space-y-4 text-sm w-full">
                <a
                  ...
                  className="flex items-start gap-2.5 text-slate-500 hover:text-sky-600 transition-colors duration-150"
                >
