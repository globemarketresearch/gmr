...
interface FilterSidebarProps {
  ...
  /**
   * Which CTA card to show below "Browse by Industry".
   * Defaults to the "Need Custom Research?" card.
   */
  ctaVariant?: 'custom-research' | 'submit-news';
}

export default function FilterSidebar({
  activeCategorySlug,
  onCategorySelect,
  ctaVariant = 'custom-research',
}: FilterSidebarProps) {
